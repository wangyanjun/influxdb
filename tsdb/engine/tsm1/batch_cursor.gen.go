...
func (e *Engine) buildFloatBatchCursor(measurement, seriesKey, field string, opt query.IteratorOptions) tsdb.FloatBatchCursor {
	key := SeriesFieldKeyBytes(seriesKey, field)
	cacheValues := e.Cache.Values(key)
	keyCursor := e.KeyCursor(key, opt.SeekTime(), opt.Ascending)
...
func (e *Engine) buildIntegerBatchCursor(measurement, seriesKey, field string, opt query.IteratorOptions) tsdb.IntegerBatchCursor {
	key := SeriesFieldKeyBytes(seriesKey, field)
	cacheValues := e.Cache.Values(key)
	keyCursor := e.KeyCursor(key, opt.SeekTime(), opt.Ascending)
...
func (e *Engine) buildUnsignedBatchCursor(measurement, seriesKey, field string, opt query.IteratorOptions) tsdb.UnsignedBatchCursor {
	key := SeriesFieldKeyBytes(seriesKey, field)
	cacheValues := e.Cache.Values(key)
	keyCursor := e.KeyCursor(key, opt.SeekTime(), opt.Ascending)
...
func (e *Engine) buildStringBatchCursor(measurement, seriesKey, field string, opt query.IteratorOptions) tsdb.StringBatchCursor {
	key := SeriesFieldKeyBytes(seriesKey, field)
	cacheValues := e.Cache.Values(key)
	keyCursor := e.KeyCursor(key, opt.SeekTime(), opt.Ascending)
...
func (e *Engine) buildBooleanBatchCursor(measurement, seriesKey, field string, opt query.IteratorOptions) tsdb.BooleanBatchCursor {
	key := SeriesFieldKeyBytes(seriesKey, field)
	cacheValues := e.Cache.Values(key)
	keyCursor := e.KeyCursor(key, opt.SeekTime(), opt.Ascending)
...
func newFloatRangeBatchCursor(key string, time int64, asc bool, cur tsdb.FloatBatchCursor) tsdb.FloatBatchCursor {
	if asc {
...
func newIntegerRangeBatchCursor(key string, time int64, asc bool, cur tsdb.IntegerBatchCursor) tsdb.IntegerBatchCursor {
	if asc {
...
func newUnsignedRangeBatchCursor(key string, time int64, asc bool, cur tsdb.UnsignedBatchCursor) tsdb.UnsignedBatchCursor {
	if asc {
...
func newStringRangeBatchCursor(key string, time int64, asc bool, cur tsdb.StringBatchCursor) tsdb.StringBatchCursor {
	if asc {
...
func newBooleanRangeBatchCursor(key string, time int64, asc bool, cur tsdb.BooleanBatchCursor) tsdb.BooleanBatchCursor {
	if asc {
